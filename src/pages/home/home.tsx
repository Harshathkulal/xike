    ...
    <div>
      ...
      <div className="flex justify-center">
        <div className="flex  overflow-x-scroll gap-4">
          <Link to="shoe/dunk" className="flex-none overflow-hidden inline-block">
          <img
          ...
          <Link to="shoe/airforce" className="flex-none overflow-hidden inline-block">
          <img
          ...
          <Link to="shoe/sss" className="flex-none overflow-hidden inline-block">
          <img
          ...
          <Link to="shoe/blaz" className="flex-none overflow-hidden inline-block">
          <img
